...
#20180819 Boris Zinshteyn - Edited to allow use of gzipped files, and to change in-read search space in read for my own needs. Added support for gzipped files
...
KEY_REGION_START = 16 #start index of key region
...
def count_spacers(input_file, fastq_file, output_file, guide_g): 
	...
	if fastq_file.endswith('.gz'):
		handle = gzip.open(fastq_file, "rU")
	else:
	...
	with open('%s_stats.txt' % output_file, 'w') as infile:
